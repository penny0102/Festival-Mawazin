export function Cards({name,  image, time, id, setRem, buttonName, classNameConfige}){
    return (
        ...
        <div className=''>
            ...
            <img className='h-60 w-60 rounded-2xl shadow-md shadow-black' src={image}/>
            </div>
            <div className='bg-[#282d67] rounded-2xl text-center py-4 px-5 font-mono mt-5 h-50 shadow-md shadow-black border-2 border-black hover:translate-y-2 hover:scale-[1.05] duration-500'>
